...
export interface ThemeConfig {
  ...
  description: string;
  defaultModifiedObject: DefaultModifiedObjectConfig;
}
...
export const THEME_CONFIGS: Record<number, ThemeConfig> = {
  1: {
    ...
    defaultModifiedObject: {
      // TODO: Replace with actual object ID from product team
      originalObjectId: "PLACEHOLDER_OBJECT_ID_1",
      coordinates: {
        x: 0,    // TODO: Get from product team
        y: 0     // TODO: Get from product team
      },
      isReversed: false,
      itemFunction: null,
      additionalData: {
  ...
  2: {
    ...
    defaultModifiedObject: {
      // TODO: Replace with actual object ID from product team
      originalObjectId: "PLACEHOLDER_OBJECT_ID_2",
      coordinates: {
        x: 0,    // TODO: Get from product team
        y: 0     // TODO: Get from product team
      },
  ...
  3: {
    ...
    defaultModifiedObject: {
      // TODO: Replace with actual object ID from product team
      originalObjectId: "PLACEHOLDER_OBJECT_ID_3",
      coordinates: {
        x: 0,    // TODO: Get from product team
        y: 0     // TODO: Get from product team
      },
  ...
  4: {
    ...
    defaultModifiedObject: {
      // TODO: Replace with actual object ID from product team
      originalObjectId: "PLACEHOLDER_OBJECT_ID_4",
      coordinates: {
        x: 0,    // TODO: Get from product team
        y: 0     // TODO: Get from product team
      },
  ...
  5: {
    ...
    defaultModifiedObject: {
      // TODO: Replace with actual object ID from product team
      originalObjectId: "PLACEHOLDER_OBJECT_ID_5",
      coordinates: {
        x: 0,    // TODO: Get from product team
        y: 0     // TODO: Get from product team
      },
...
/**
 * Get default modified object config for a theme
 */
export function getDefaultModifiedObjectConfig(themeId: number): DefaultModifiedObjectConfig | null {
  const config = THEME_CONFIGS[themeId];
  return config ? config.defaultModifiedObject : null;
}
